...
test/CMakeFiles/stable_norm_1.dir/stable_norm.cpp.o: ../test/stable_norm.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/data/simuphysics/eigen/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object test/CMakeFiles/stable_norm_1.dir/stable_norm.cpp.o"
	cd /data/simuphysics/eigen/build/test && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/stable_norm_1.dir/stable_norm.cpp.o -c /data/simuphysics/eigen/test/stable_norm.cpp
...
test/CMakeFiles/stable_norm_1.dir/stable_norm.cpp.i: cmake_force
	...
	cd /data/simuphysics/eigen/build/test && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /data/simuphysics/eigen/test/stable_norm.cpp > CMakeFiles/stable_norm_1.dir/stable_norm.cpp.i
...
test/CMakeFiles/stable_norm_1.dir/stable_norm.cpp.s: cmake_force
	...
	cd /data/simuphysics/eigen/build/test && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /data/simuphysics/eigen/test/stable_norm.cpp -o CMakeFiles/stable_norm_1.dir/stable_norm.cpp.s
...
test/stable_norm_1: test/CMakeFiles/stable_norm_1.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/data/simuphysics/eigen/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable stable_norm_1"
	cd /data/simuphysics/eigen/build/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/stable_norm_1.dir/link.txt --verbose=$(VERBOSE)
...
test/CMakeFiles/stable_norm_1.dir/clean:
	cd /data/simuphysics/eigen/build/test && $(CMAKE_COMMAND) -P CMakeFiles/stable_norm_1.dir/cmake_clean.cmake
.PHONY : test/CMakeFiles/stable_norm_1.dir/clean

test/CMakeFiles/stable_norm_1.dir/depend:
	cd /data/simuphysics/eigen/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /data/simuphysics/eigen /data/simuphysics/eigen/test /data/simuphysics/eigen/build /data/simuphysics/eigen/build/test /data/simuphysics/eigen/build/test/CMakeFiles/stable_norm_1.dir/DependInfo.cmake --color=$(COLOR)
